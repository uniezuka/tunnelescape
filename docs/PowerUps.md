...
* New players start with full stock (3 of each). The tutorial (Levels 2-4) forces the use of one power-up per level, and each of those is a genuine completion, so it permanently spends 1 charge — a player who goes straight through the tutorial without pausing reaches Level 5 with 2 of each in stock.
